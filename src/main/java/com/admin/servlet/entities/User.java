package com.admin.servlet.entities;
...
public class User {
	...
	public User(int id, String name, String email, String password, String phone_number) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
	...
	public User(String name, String email, String password, String phone_number, String address, String landmark,
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", email=" + email + ", password=" + password + ", phone_number="
				+ phone_number + ", address=" + address + ", landmark=" + landmark + ", city=" + city + ", state="
